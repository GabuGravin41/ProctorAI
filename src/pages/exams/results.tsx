...
import {
  ...
  ChevronRight, Loader2, X, UploadCloud, Copy, Check
} from "lucide-react";
    ...
    <InstructorLayout>
      <div className="p-8 max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <Button onClick={() => setInviteModalOpen(true)} className="bg-primary hover:bg-primary/90 text-white font-medium shadow-sm transition-all duration-150">
            Invite Students
          </Button>
        </div>
